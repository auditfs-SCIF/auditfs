// Partie 2 — Base de données d'intégrité
// Binôme : Étudiant 3 + Étudiant 4

pub mod compress;
pub mod hmac;
// pub mod serialize;   // plus besoin, le code est inclus ci-dessous

// ---------- code de serialize.rs ----------
